                ...
                <div class="col-lg-9 col-md-11">
                    <div class="capt">
                        <div class="text-center">
                            <h1 class="color-font mb-10 fw-700">Register an Account<br></h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form method="POST" action="/users">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <input class="p-2 border" type="text" name="name" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        <label for="password_confirmation" class="inline-block text-lg mb-2">Password Confirmation</label>
                                        <input class="p-2 border" type="password" name="password_confirmation" value="{{ old('password_confirmation') }}">
